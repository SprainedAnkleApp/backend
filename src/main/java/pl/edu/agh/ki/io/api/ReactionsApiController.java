...
public class ReactionsApiController {
    ...
    public ResponseEntity<ReactionResponse> createReaction(@AuthenticationPrincipal User user, @PathVariable("wallelementid") Long wallElementId){
        Reaction reaction = new Reaction(new ReactionKey(user.getId(), wallElementId), ReactionType.LOVE);
    ...
    public ResponseEntity<ReactionResponse> deleteReaction(@AuthenticationPrincipal User user, @PathVariable("wallelementid") Long wallElementId){
